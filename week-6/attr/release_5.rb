...
# refactor this code to move method assignments to attr_ attributes. Like we did with age. 
#Let's pare down the superfluous code.
...
# note that there is a way to add all of the variables like :age on one line, how would we do that?
  ...
  def initialize
    @age = 27, @name = "Kim", @occupation = "Cartographer"
  end
