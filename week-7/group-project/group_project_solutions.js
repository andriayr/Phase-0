...
// the function should return the average of the middle 2 numbers.  As the writer of the user stories, I made several mistakes.  First, I gave the wrong example median in my description of that. I also think that I tried to give too specific a method to solving the problem, instead of saying simply what
// the functions should do and trusting the next person to figure out the steps. My stories, looking back, look too much like psuedocode without the organization that psuedocode brings.  The person that wrote the psuedo-code managed to understand me I think, but wrote confusingly that one should create
...
// the indexes being looked up being decimal numbers in odd length arrays.  But I think you all did a great job with what you had to work with.  I don't think we should feel too bad about our mistakes, after all, the test code itself was not working entirely correctly either, I had to fix some things just to get them to
