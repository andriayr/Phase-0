...
# //Require relative grants access to the code based on the file that it is calling. It provides access based on the 
# //file name, rather than the directory. It loaders quicker than require.  
# 
# //Require-it finds the file based on the current directory and uses
# //$LOAD_PAth
# //
...
class VirusPredictor
  ...
  #Initialize three instance variables state, population and population density
  ...
  #Calling two methods predicted deaths and speed of spread
  def virus_effects
  ...
  #Predicting the number of deaths based on population density
  ...
  #Calculating how quickly the virus will spread, using a counter. The counter speed increases based on the size of the population density. The lower the density, the quicker the speed of spread. 
...
STATE_DATA.each {|state, data|
  america = VirusPredictor.new("#{state}", STATE_DATA["#{state}"][:population_density], STATE_DATA["#{state}"][:population])
america.virus_effects
  }
